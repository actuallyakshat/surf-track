...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "plasmo-rounded-lg plasmo-border plasmo-bg-card plasmo-text-card-foreground plasmo-shadow-sm",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "plasmo-text-2xl plasmo-font-semibold plasmo-leading-none plasmo-tracking-tight",
      className
    )}
    {...props}
  />
